...
const Register = () => {
  ...
  const validateStep1 = () => {
    ...
    if (!churchName.trim()) newErrors.churchName = "Nome da igreja é obrigatório";
  ...
  const validateStep2 = () => {
    ...
    if (!pastorName.trim()) newErrors.pastorName = "Nome é obrigatório";
    if (!pastorEmail.trim()) {
      newErrors.pastorEmail = "Email é obrigatório";
    } else if (!/\S+@\S+\.\S+/.test(pastorEmail)) {
      newErrors.pastorEmail = "Email inválido";
    }
    if (!pastorPassword) {
      newErrors.pastorPassword = "Senha é obrigatória";
    } else if (pastorPassword.length < 6) {
      newErrors.pastorPassword = "Senha deve ter no mínimo 6 caracteres";
    }
    if (pastorPassword !== pastorPasswordConfirm) {
      newErrors.pastorPasswordConfirm = "As senhas não coincidem";
    }
        ...
        <Card className="w-full max-w-md border-2 shadow-lg animate-fade-in-up">
          <CardContent className="pt-12 pb-8 text-center space-y-6">
            ...
            <div className="space-y-2">
              <h2 className="text-2xl font-bold">Igreja cadastrada com sucesso!</h2>
              <p className="text-muted-foreground">
                Enviamos um email de confirmação para {pastorEmail}
              </p>
            </div>
          ...
          <CardHeader className="space-y-4 pb-6">
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-3">
                <div className="p-2 bg-gradient-spiritual rounded-xl">
            ...
            {currentStep === 1 && (
              <div className="space-y-4 animate-fade-in">
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <Input
                      ...
                      className={`h-11 pl-10 ${errors.churchName ? 'border-destructive' : ''}`}
                      value={churchName}
                      onChange={(e) => setChurchName(e.target.value)}
                    />
                  </div>
                  {errors.churchName && (
                    <p className="text-sm text-destructive animate-fade-in">{errors.churchName}</p>
                  )}
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <Input
                      ...
                      className={`h-11 pl-10 ${errors.churchAddress ? 'border-destructive' : ''}`}
                      value={churchAddress}
                      onChange={(e) => setChurchAddress(e.target.value)}
                    />
                  </div>
                  {errors.churchAddress && (
                    <p className="text-sm text-destructive animate-fade-in">{errors.churchAddress}</p>
                  )}
                </div>
                ...
                <div className="space-y-2">
                  ...
                  {errors.churchPhone && (
                    <p className="text-sm text-destructive animate-fade-in">{errors.churchPhone}</p>
                  )}
                </div>
              </div>
            )}
              ...
              <div className="space-y-4 animate-fade-in">
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <Input
                      ...
                      className={`h-11 pl-10 ${errors.pastorName ? 'border-destructive' : ''}`}
                      value={pastorName}
                      onChange={(e) => setPastorName(e.target.value)}
                    />
                  </div>
                  {errors.pastorName && (
                    <p className="text-sm text-destructive animate-fade-in">{errors.pastorName}</p>
                  )}
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <Input
                      ...
                      className={`h-11 pl-10 ${errors.pastorEmail ? 'border-destructive' : ''}`}
                      value={pastorEmail}
                      onChange={(e) => setPastorEmail(e.target.value)}
                    />
                  </div>
                  {errors.pastorEmail && (
                    <p className="text-sm text-destructive animate-fade-in">{errors.pastorEmail}</p>
                  )}
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <Input
                      ...
                      type="password"
                      placeholder="••••••••"
                      className={`h-11 pl-10 ${errors.pastorPassword ? 'border-destructive' : ''}`}
                      value={pastorPassword}
                      onChange={(e) => setPastorPassword(e.target.value)}
                    />
                  </div>
                  {errors.pastorPassword && (
                    <p className="text-sm text-destructive animate-fade-in">{errors.pastorPassword}</p>
                  )}
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    <Lock className="absolute left-3 top-3 h-5 w-5 text-muted-foreground" />
                    <Input
                      id="pastorPasswordConfirm"
                      type="password"
                      placeholder="••••••••"
                      className={`h-11 pl-10 ${errors.pastorPasswordConfirm ? 'border-destructive' : ''}`}
                      value={pastorPasswordConfirm}
                      onChange={(e) => setPastorPasswordConfirm(e.target.value)}
                    />
                  </div>
                  {errors.pastorPasswordConfirm && (
                    <p className="text-sm text-destructive animate-fade-in">{errors.pastorPasswordConfirm}</p>
                  )}
                </div>
              </div>
            )}
                ...
                <div className="bg-muted/50 rounded-lg p-6 space-y-4">
                  ...
                  <div className="space-y-3 text-sm">
                    ...
                    <div>
                      ...
                      <p className="font-medium">{churchAddress}</p>
                    </div>
                    <div>
                      <p className="text-muted-foreground">Telefone</p>
                      <p className="font-medium">{churchPhone}</p>
                    </div>
                    <div className="border-t pt-3">
                      <p className="text-muted-foreground">Pastor Responsável</p>
                      <p className="font-medium">{pastorName}</p>
                      <p className="text-muted-foreground text-xs">{pastorEmail}</p>
                    </div>
                  </div>
                </div>
